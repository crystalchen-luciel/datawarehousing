...
inner join date_311 on fct.created_date= date_311.date_created
inner join complaint_type_311 on UPPER(fct.complaint_type) = UPPER(complaint_type_311.complaint_type)
where date_311.date_created = '2010-01-28'
