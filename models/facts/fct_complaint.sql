...
left join complaint_type on fct.major_category = complaint_type.major_category
and fct.minor_category = complaint_type.minor_category
left join location on fct.borough = location.borough
and fct.post_code = location.zip_code
